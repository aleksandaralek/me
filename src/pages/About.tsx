      ...
      <div className="flex flex-col gap-4 md:gap-8">
        ...
        <Card className="mt-8">
          ...
          <CardBody>
            ...
            8 years of experience, based in Baric, Serbia.
            <br />
        ...
        <Card className="mt-8">
          ...
          <CardBody>
            <div className="flex flex-col gap-4">
              <div className="flex gap-8">
                <div className="w-32 whitespace-nowrap">2011/06-2015/12</div>

                <div>
                  <ul>
                    <li className="text-lg font-bold">Freelancer</li>
                    <li className="font-semibold text-md">Remote</li>
                    <li>
                      <br />
                    </li>
                    <li>
                    ...
                    <li>
                      Extended the existing back-end system to incorporate the
                      newly developed module.
                    </li>
                    <li>
                      Implemented an extensible integration mechanism on the
                      back end.
                    </li>
                    <li>
                      Offered general consulting on system design and planning.
                    </li>
                    <li>
              ...
              <div className="flex gap-8">
                <div className="w-32 whitespace-nowrap">2016/1-2022/11</div>
                ...
                <div>
                  <ul>
                    ...
                    <li className="font-semibold text-md">Endava</li>
                    <li>
                      <br />
                    </li>
                    <li>
                      ...
                      in Endava networking.
                    </li>
                    <li>
                      Powered up printing marketing campaigns by adding support
                      for rendering custom QR codes to for-sale and rental
                      listings, bio sites, and other resources.
                    </li>
                    <li>
                      Collected metrics for user interaction and presented them
