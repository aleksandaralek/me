      ...
      <Card className="w-full mx-auto mb-8 md:w-1/2">
        <CardBody>
          <p>
            ...
            You can find my profile on HackerRank at <Link href="https://www.hackerrank.com/profile/aleksandardeveo1" target="_blank">https://www.hackerrank.com/profile/aleksandardeveo1</Link>, where you can see my full
